yama_2_GFX.h、yama_2_GFX.cpp、random_raspberry_64px_GFXcanvas8_grayscale.cpp、CMakeLists.txtを同じフォルダに置き pico-sdkでビルドしてください。  
...
横64、縦64を左上から右方向に順番に単純に並べただけの配列です。  
